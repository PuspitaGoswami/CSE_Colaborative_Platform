...
<div style="margin-top: 20px;" class="event" style="background: #C5DDEB;">
...
<div class="container">
	...
	<div class="contentsection contemplete clear">
		...
		<?php	
			...
			$query = "SELECT id, title, body,date FROM tbl_event WHERE title LIKE '%$search%' OR body LIKE '%$search%' OR date LIKE '%$search%'  limit $start_from, $per_page";
