...
<div class="page-wrapper">
	...
	<div class="content clearfix">
		...
		<?php	
				$query = "select * from tbl_blog where active=1 and cat=$id order by id desc limit $start_from, $per_page";
				$post= $db->select($query);
				if ($post) {?>
				<h1 class="recent-post-title">Post</h1><?php
...
<?php 
	...
	<?php for($i=1; $i<=$total_pages; $i++){?>
		<a style="padding: 2px;font-size: 30px;" href="blog.php?page= <?php echo $i;?>"><?php echo $i?></a>
