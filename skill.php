...
?>
		...
		<div class="wrapper">
            ...
            <?php
				...
				if($_SERVER["REQUEST_METHOD"]=="POST"){
					...
					if(empty($user) or empty($name) or empty($percentage)){
						echo "<span style='color:#e53d37'>Field must not be empty</span>";
					}
					else{
						$query = "INSERT INTO tbl_s(user_name,name,percentage) VALUES('".$user."', '".$name."', '".$percentage."')";
        ...
        <p class="user">Skill List</p>
			<table class="style_table" style="text-align:center">
				...
				<?php 
				$i = 0;
				$query = "SELECT * FROM tbl_s WHERE user_name = '$user'";
