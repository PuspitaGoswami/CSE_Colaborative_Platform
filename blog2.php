...
<body>
		...
		<?php 
				...
				$maximum=$row['maximum'];
				$maximum2=$row['maximum']-1;
				$maximum3=$row['maximum']-2;
			    $maximum4=$row['maximum']-3;	
...
<div class="page-wrapper">
	...
	<div class="post-slider">
		...
		<div class="post-wrapper">
					<?php	
				$query = "SELECT * FROM tbl_blog WHERE active=1 AND (likes=$array[0] OR likes=$array[1] OR likes=$array[2]) AND likes!=0  order by id desc limit $start_from, $per_page";
		...
		<div class="post">
			...
			<div class="post-info">
				<a style="font-size: 20px;" href="single.html"><?php echo $fm->textShorten2($result['title'],28);?></a>
				<div style="font-size: 18px;margin: 5px; margin-bottom: 5px; color:#093c99;">
...
<?php 
	...
	<a style="font-size: 30px; padding: 30px;" href="blog2.php?page=<?php echo '1';?>"><?php echo '<'; ?></a>


	<?php for($i=1; $i<=$total_pages; $i++){?>
		<a style="padding: 2px;font-size: 30px;" href="blog2.php?page= <?php echo $i;?>"><?php echo $i?></a>

	<?php }?>


	 <a style="font-size: 30px; padding: 30px;" href="blog2.php?page=<?php echo $total_pages;?>"><?php echo '>'; ?></a>
	</span>
