	...
	<div class="content clearfix">
		...
		<div class="main-content single">
			...
			?>
		        ...
		        <img src="<?php echo $result['image']; ?>" alt="post image" style="height:200px; width:730px;"/> 
		...
		<?php }} ?>
				  ...
				  <?php if (isset($_POST['cmnt_submit'])) {
                            ...
                            if($comment == ''){
                                ...
                                ?>
                                <script type="text/javascript">
                                    location.replace("single.php?id=<?php echo $result['id']?>");
                                </script>
        ...
        ?>
					...
					<a href="" class="title"><h4><?php echo $result['title']; ?></h4></a>
